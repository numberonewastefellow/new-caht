  ...
  <div id="error-modal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="modal-description">The VertualAI configuration needs to be updated. Please check your settings or contact your VertualAI administrator.</p>
...
const authModalHTML = `
  <div id="error-modal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="modal-description">You need to log in to access VertualAI. Click the button below to authenticate.</p>
      </div>
      <div class="modal-footer">
        <div class="button-container">
          <button id="open-auth" class="button primary">Log In to VertualAI</button>
        </div>
      </div>
    </div>
  </div>
