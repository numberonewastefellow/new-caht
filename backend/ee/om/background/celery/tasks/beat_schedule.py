...
from ee.om.configs.app_configs import CHECK_TTL_MANAGEMENT_TASK_FREQUENCY_IN_HOURS
...
from om.background.celery.tasks.beat_schedule import generate_cloud_tasks
from om.background.celery.tasks.beat_schedule import (
