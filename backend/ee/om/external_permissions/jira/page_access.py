...
from ee.om.external_permissions.jira.models import Holder
from ee.om.external_permissions.jira.models import Permission
from ee.om.external_permissions.jira.models import User
