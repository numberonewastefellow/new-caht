...
from ee.om.server.scim.models import ScimEmail
from ee.om.server.scim.models import ScimError
...
from ee.om.server.scim.models import ScimMeta
from ee.om.server.scim.models import ScimName
from ee.om.server.scim.models import ScimPatchRequest
from ee.om.server.scim.models import ScimResourceType
from ee.om.server.scim.models import ScimSchemaDefinition
from ee.om.server.scim.models import ScimServiceProviderConfig
...
from ee.om.server.scim.schema_definitions import GROUP_RESOURCE_TYPE
from ee.om.server.scim.schema_definitions import GROUP_SCHEMA_DEF
from ee.om.server.scim.schema_definitions import SERVICE_PROVIDER_CONFIG
from ee.om.server.scim.schema_definitions import USER_RESOURCE_TYPE
from ee.om.server.scim.schema_definitions import USER_SCHEMA_DEF
