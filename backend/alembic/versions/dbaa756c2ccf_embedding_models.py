...
from om.configs.model_configs import ASYM_PASSAGE_PREFIX
from om.configs.model_configs import ASYM_QUERY_PREFIX
from om.configs.model_configs import DOC_EMBEDDING_DIM
from om.configs.model_configs import DOCUMENT_ENCODER_MODEL
from om.configs.model_configs import NORMALIZE_EMBEDDINGS
from om.configs.model_configs import OLD_DEFAULT_DOCUMENT_ENCODER_MODEL
from om.configs.model_configs import OLD_DEFAULT_MODEL_DOC_EMBEDDING_DIM
from om.configs.model_configs import OLD_DEFAULT_MODEL_NORMALIZE_EMBEDDINGS
from om.db.enums import EmbeddingPrecision
from om.db.models import IndexModelStatus
from om.db.search_settings import user_has_overridden_embedding_model
from om.indexing.models import IndexingSetting
from om.natural_language_processing.search_nlp_models import clean_model_name
...
def _get_new_default_embedding_model() -> IndexingSetting:
    return IndexingSetting(
        ...
        index_name=f"chunk_{clean_model_name(DOCUMENT_ENCODER_MODEL)}",
        multipass_indexing=False,
        enable_contextual_rag=False,
        api_url=None,
    )
