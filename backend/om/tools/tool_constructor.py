...
from om.auth.oauth_token_manager import OAuthTokenManager
...
from om.tools.tool_implementations.custom.custom_tool import (
...
from om.tools.tool_implementations.open_url.open_url_tool import (
    OpenURLTool,
)
...
from om.tools.tool_implementations.web_search.web_search_tool import (
    WebSearchTool,
)
from om.utils.headers import header_dict_to_header_list
        ...
        if db_tool_model.in_code_tool_id:
            ...
            # Handle Web Search Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Internet search tool requires a search provider API key, please contact your VertualAI admin to get it added!"
                    )
            ...
            # Handle Open URL Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Open URL tool requires a web content provider, please contact your VertualAI admin to get it configured!"
                    )
