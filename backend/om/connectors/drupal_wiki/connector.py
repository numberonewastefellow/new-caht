...
from om.configs.app_configs import CONTINUE_ON_CONNECTOR_FAILURE
from om.configs.app_configs import DRUPAL_WIKI_ATTACHMENT_SIZE_THRESHOLD
...
from om.connectors.cross_connector_utils.rate_limit_wrapper import rate_limit_builder
from om.connectors.cross_connector_utils.rate_limit_wrapper import rl_requests
from om.connectors.drupal_wiki.models import DrupalWikiCheckpoint
from om.connectors.drupal_wiki.models import DrupalWikiPage
from om.connectors.drupal_wiki.models import DrupalWikiPageResponse
from om.connectors.drupal_wiki.models import DrupalWikiSpaceResponse
from om.connectors.drupal_wiki.utils import build_drupal_wiki_document_id
...
from om.connectors.interfaces import ConnectorFailure
        ...
        **kwargs: Any,
        ...
        if deprecated_found:
            raise ConnectorValidationError(
                ...
                f"Please delete and recreate this connector, or contact VertualAi support "
