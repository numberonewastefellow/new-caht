...
from om.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_OBJECTS
from om.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_PREFIXES
from om.connectors.salesforce.blacklist import SALESFORCE_BLACKLISTED_SUFFIXES
