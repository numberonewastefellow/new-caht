...
from om.context.search.utils import get_query_embedding
...
from om.federated_connectors.federated_retrieval import (
...
def search_chunks(
    ...
    federated_retrieval_infos = get_federated_retrieval_functions(
        ...
        knowledge_file_ids=query_request.filters.knowledge_file_ids,
    )
