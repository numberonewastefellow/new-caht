...
from om.context.search.models import SearchDoc as ServerSearchDoc
from om.db.models import ChatMessage
from om.db.models import ChatMessage__SearchDoc
...
def add_search_docs_to_tool_call(
    ...
    Args:
        ...
        db_session: The database session
    """
    from om.db.models import ToolCall__SearchDoc
