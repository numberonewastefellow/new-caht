...
from om.auth.api_key import build_displayable_api_key
from om.auth.api_key import generate_api_key
from om.auth.api_key import hash_api_key
from om.auth.schemas import UserRole
from om.configs.constants import DISCORD_SERVICE_API_KEY_NAME
from om.db.api_key import insert_api_key
from om.db.models import ApiKey
from om.db.models import DiscordBotConfig
...
from om.server.api_key.models import APIKeyArgs
...
def get_or_create_discord_service_api_key(
    ...
    VertualAi API pods when sending chat requests.
