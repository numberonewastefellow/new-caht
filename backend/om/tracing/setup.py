...
from om.configs.app_configs import BRAINTRUST_API_KEY
from om.configs.app_configs import BRAINTRUST_PROJECT
from om.configs.app_configs import LANGFUSE_HOST
from om.configs.app_configs import LANGFUSE_PUBLIC_KEY
from om.configs.app_configs import LANGFUSE_SECRET_KEY
from om.configs.app_configs import PHOENIX_COLLECTOR_ENDPOINT
...
def _setup_braintrust() -> None:
    ...
    from om.tracing.braintrust_tracing_processor import BraintrustTracingProcessor
    from om.tracing.framework import add_trace_processor
    from om.tracing.masking import mask_sensitive_data
...
def _setup_langfuse() -> None:
    ...
    from om.tracing.framework import add_trace_processor
    from om.tracing.langfuse_tracing_processor import LangfuseTracingProcessor
...
def _setup_phoenix() -> None:
    ...
    from om.tracing.framework import add_trace_processor
    from om.tracing.phoenix_tracing_processor import PhoenixTracingProcessor
