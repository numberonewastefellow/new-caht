# Overview of VertualAI Background Jobs
...
| `check_for_document_index_sync_task` | 20s | Finds stale documents/document sets → dispatches sync tasks to `DOC_INDEX_METADATA_SYNC` queue |
