...
from om.server.tenants.provisioning import setup_tenant
from om.server.tenants.schema_management import create_schema_if_not_exists
from om.server.tenants.schema_management import get_current_alembic_version
...
def pre_provision_tenant() -> None:
    ...
    try:
        ...
        if tenant_id:
            ...
            try:
                from om.server.tenants.provisioning import (
