...
from om.configs.app_configs import INDEXING_EMBEDDING_MODEL_NUM_THREADS
from om.configs.app_configs import LARGE_CHUNK_RATIO
from om.configs.model_configs import BATCH_SIZE_ENCODE_CHUNKS
from om.configs.model_configs import (
...
from om.natural_language_processing.constants import DEFAULT_COHERE_MODEL
from om.natural_language_processing.constants import DEFAULT_OPENAI_MODEL
from om.natural_language_processing.constants import DEFAULT_VERTEX_MODEL
from om.natural_language_processing.constants import DEFAULT_VOYAGE_MODEL
from om.natural_language_processing.constants import EmbeddingModelTextType
from om.natural_language_processing.exceptions import CohereBillingLimitError
from om.natural_language_processing.exceptions import ModelServerRateLimitError
from om.natural_language_processing.utils import get_tokenizer
from om.natural_language_processing.utils import tokenizer_trim_content
from om.utils.logger import setup_logger
from om.utils.search_nlp_models_utils import pass_aws_key
...
class CloudEmbedding:
    ...
    async def _embed_cohere(
        ...
        for text_batch in batch_list(texts, _COHERE_MAX_INPUT_LEN):
            # Does not use the same tokenizer as the VertualAi API server but it's approximately the same
