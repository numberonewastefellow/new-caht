...
from om.configs.onyxbot_configs import ONYX_BOT_FOLLOWUP_EMOJI
...
from om.db.feedback import create_doc_retrieval_feedback
from om.db.users import get_user_by_email
from om.onyxbot.slack.blocks import build_follow_up_resolved_blocks
from om.onyxbot.slack.blocks import build_slack_response_blocks
from om.onyxbot.slack.blocks import get_document_feedback_blocks
...
from om.onyxbot.slack.constants import FeedbackVisibility
...
from om.onyxbot.slack.utils import fetch_group_ids_from_names
...
from om.onyxbot.slack.utils import get_feedback_visibility
...
from om.server.query_and_chat.models import ChatMessageDetail
    ...
    if action_id == SHOW_EVERYONE_ACTION_ID:
        ...
        try:
            ...
            respond_in_thread_or_channel(
                ...
                text="Hello! VertualAI has some results for you!",
                blocks=all_blocks,
