...
from om.db.discord_bot import get_channel_config_by_discord_ids
...
from om.onyxbot.discord.exceptions import APIError
...
async def send_error_response(
    ...
    error_msg = "Sorry, I encountered an error processing your message. You may want to contact VertualAI for support :sweat_smile:"
