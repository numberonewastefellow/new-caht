...
from om.chat.prompt_utils import (
...
from om.prompts.chat_prompts import IMAGE_GEN_REMINDER
from om.prompts.chat_prompts import OPEN_URL_REMINDER
...
from om.server.query_and_chat.streaming_models import ToolCallDebug
from om.server.query_and_chat.streaming_models import TopLevelBranching
from om.tools.built_in_tools import CITEABLE_TOOLS_NAMES
from om.tools.built_in_tools import STOPPING_TOOLS_NAMES
from om.tools.interface import Tool
from om.tools.models import ChatFile
from om.tools.models import MemoryToolResponseSnapshot
...
from om.tools.tool_implementations.images.models import (
    FinalImageGenerationResponse,
)
from om.tools.tool_implementations.memory.models import MemoryToolResponse
...
def run_llm_loop(
    ...
    with trace(
        ...
        from om.llm.litellm_singleton.config import (
            initialize_litellm,
