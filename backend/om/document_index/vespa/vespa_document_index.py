...
from om.configs.app_configs import RECENCY_BIAS_MULTIPLIER
from om.configs.app_configs import RERANK_COUNT
from om.configs.chat_configs import DOC_TIME_DECAY
from om.configs.chat_configs import HYBRID_ALPHA
from om.configs.chat_configs import TITLE_CONTENT_RATIO
from om.configs.chat_configs import VESPA_SEARCHER_THREADS
...
from om.document_index.chunk_content_enrichment import cleanup_content_for_chunks
from om.document_index.document_index_utils import get_document_chunk_ids
...
from om.document_index.vespa.chunk_retrieval import batch_search_api_retrieval
from om.document_index.vespa.chunk_retrieval import get_all_chunks_paginated
from om.document_index.vespa.chunk_retrieval import get_chunks_via_visit_api
from om.document_index.vespa.chunk_retrieval import parallel_visit_api_retrieval
from om.document_index.vespa.chunk_retrieval import query_vespa
from om.document_index.vespa.deletion import delete_vespa_chunks
from om.document_index.vespa.indexing_utils import BaseHTTPXClientContext
from om.document_index.vespa.indexing_utils import batch_index_vespa_chunks
from om.document_index.vespa.indexing_utils import check_for_final_chunk_existence
from om.document_index.vespa.indexing_utils import clean_chunk_id_copy
from om.document_index.vespa.indexing_utils import GlobalHTTPXClientContext
from om.document_index.vespa.indexing_utils import TemporaryHTTPXClientContext
from om.document_index.vespa.internal_types import EnrichedDocumentIndexingInfo
from om.document_index.vespa.internal_types import MinimalDocumentIndexingInfo
from om.document_index.vespa.internal_types import VespaChunkRequest
...
from om.document_index.vespa.shared_utils.vespa_request_builders import (
    build_vespa_filters,
)
from om.document_index.vespa_constants import BATCH_SIZE
from om.document_index.vespa_constants import CHUNK_ID
from om.document_index.vespa_constants import CONTENT_SUMMARY
...
from om.document_index.vespa_constants import NUM_THREADS
from om.document_index.vespa_constants import SEARCH_ENDPOINT
from om.document_index.vespa_constants import VESPA_APPLICATION_ENDPOINT
from om.document_index.vespa_constants import VESPA_TIMEOUT
from om.document_index.vespa_constants import YQL_BASE
from om.indexing.models import DocMetadataAwareIndexChunk
from om.key_value_store.factory import get_shared_kv_store
...
from om.utils.batching import batch_generator
...
def deploy_vespa_schemas(
    ...
    vespa_schema_path = os.path.join(
        os.getcwd(), "om", "document_index", "vespa", "app_config"
    )
...
class VespaDocumentIndex(DocumentIndex):
    ...
    def update(
        ...
        # which is kicked off by check_for_document_index_sync_task, notably before a document
