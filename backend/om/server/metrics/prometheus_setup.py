"""Prometheus metrics setup for the VertualAi API server.
...
from om.server.metrics.postgres_connection_pool import pool_timeout_handler
...
def setup_prometheus_metrics(app: Starlette) -> None:
    """Initialize HTTP request metrics for the VertualAi API server.
