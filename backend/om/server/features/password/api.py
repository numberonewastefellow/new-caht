...
from om.server.features.password.models import ChangePasswordRequest
from om.server.features.password.models import UserResetRequest
from om.server.features.password.models import UserResetResponse
