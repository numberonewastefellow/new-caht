...
from om.db.enums import MCPServerStatus
from om.db.enums import MCPTransport
from om.db.mcp import create_connection_config
from om.db.mcp import create_mcp_server__no_commit
from om.db.mcp import delete_all_user_connection_configs_for_server_no_commit
from om.db.mcp import delete_connection_config
from om.db.mcp import delete_mcp_server
from om.db.mcp import delete_user_connection_configs_for_server
from om.db.mcp import extract_connection_data
...
from om.db.mcp import update_mcp_server__no_commit
from om.db.mcp import upsert_user_connection_config
from om.db.models import MCPConnectionConfig
from om.db.models import MCPServer as DbMCPServer
from om.db.models import Tool
from om.db.models import User
from om.db.tools import create_tool__no_commit
from om.db.tools import delete_tool__no_commit
from om.db.tools import get_tools_by_mcp_server_id
from om.redis.redis_pool import get_redis_client
from om.server.features.mcp.models import MCPApiKeyResponse
from om.server.features.mcp.models import MCPAuthTemplate
from om.server.features.mcp.models import MCPConnectionData
from om.server.features.mcp.models import MCPOAuthCallbackResponse
from om.server.features.mcp.models import MCPOAuthKeys
from om.server.features.mcp.models import MCPServer
from om.server.features.mcp.models import MCPServerCreateResponse
from om.server.features.mcp.models import MCPServerSimpleCreateRequest
from om.server.features.mcp.models import MCPServerSimpleUpdateRequest
from om.server.features.mcp.models import MCPServersResponse
from om.server.features.mcp.models import MCPServerUpdateResponse
from om.server.features.mcp.models import MCPToolCreateRequest
from om.server.features.mcp.models import MCPToolListResponse
from om.server.features.mcp.models import MCPToolUpdateRequest
from om.server.features.mcp.models import MCPUserCredentialsRequest
from om.server.features.mcp.models import MCPUserOAuthConnectRequest
from om.server.features.mcp.models import MCPUserOAuthConnectResponse
from om.server.features.tool.models import ToolSnapshot
from om.tools.tool_implementations.mcp.mcp_client import discover_mcp_tools
from om.tools.tool_implementations.mcp.mcp_client import initialize_mcp_client
from om.tools.tool_implementations.mcp.mcp_client import log_exception_group
from om.utils.encryption import mask_string
...
def make_oauth_provider(
    ...
    return OAuthClientProvider(
        ...
        client_metadata=OAuthClientMetadata(
            client_name=f"VertualAI - {mcp_server.name}",
