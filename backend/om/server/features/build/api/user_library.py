...
from om.server.features.build.configs import USER_LIBRARY_MAX_FILE_SIZE_BYTES
from om.server.features.build.configs import USER_LIBRARY_MAX_FILES_PER_UPLOAD
from om.server.features.build.configs import USER_LIBRARY_MAX_TOTAL_SIZE_BYTES
from om.server.features.build.configs import USER_LIBRARY_SOURCE_DIR
from om.server.features.build.db.user_library import get_or_create_craft_connector
from om.server.features.build.db.user_library import get_user_storage_bytes
...
from om.server.features.build.utils import sanitize_filename as api_sanitize_filename
...
def toggle_file_sync(
    ...
    """
    from om.db.document import get_documents_by_source
    from om.db.document import update_document_metadata__no_commit
...
def delete_file(
    ...
    from om.db.document import delete_document_by_id__no_commit
