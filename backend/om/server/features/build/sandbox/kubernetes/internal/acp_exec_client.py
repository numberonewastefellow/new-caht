...
from om.server.features.build.configs import ACP_MESSAGE_TIMEOUT
from om.server.features.build.configs import SSE_KEEPALIVE_INTERVAL
...
DEFAULT_CLIENT_INFO = {
    ...
    "title": "VertualAI Sandbox Agent Client (K8s Exec)",
    "version": "1.0.0",
}
