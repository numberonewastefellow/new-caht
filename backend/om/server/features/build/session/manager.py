...
from om.db.models import BuildMessage
...
from om.server.features.build.api.models import DirectoryListing
from om.server.features.build.api.models import FileSystemEntry
from om.server.features.build.api.packet_logger import get_packet_logger
from om.server.features.build.api.packet_logger import log_separator
from om.server.features.build.api.packets import BuildPacket
from om.server.features.build.api.packets import ErrorPacket
from om.server.features.build.api.rate_limit import get_user_rate_limit_status
from om.server.features.build.configs import MAX_TOTAL_UPLOAD_SIZE_BYTES
from om.server.features.build.configs import MAX_UPLOAD_FILES_PER_SESSION
from om.server.features.build.configs import PERSISTENT_DOCUMENT_STORAGE_PATH
from om.server.features.build.configs import SANDBOX_BACKEND
from om.server.features.build.configs import SandboxBackend
from om.server.features.build.db.build_session import allocate_nextjs_port
from om.server.features.build.db.build_session import create_build_session__no_commit
from om.server.features.build.db.build_session import create_message
from om.server.features.build.db.build_session import delete_build_session__no_commit
from om.server.features.build.db.build_session import (
    fetch_llm_provider_by_type_for_build_mode,
)
from om.server.features.build.db.build_session import get_build_session
from om.server.features.build.db.build_session import get_empty_session_for_user
from om.server.features.build.db.build_session import get_session_messages
from om.server.features.build.db.build_session import get_user_build_sessions
from om.server.features.build.db.build_session import update_session_activity
from om.server.features.build.db.build_session import upsert_agent_plan
from om.server.features.build.db.sandbox import create_sandbox__no_commit
from om.server.features.build.db.sandbox import get_running_sandbox_count_by_tenant
from om.server.features.build.db.sandbox import get_sandbox_by_session_id
from om.server.features.build.db.sandbox import get_sandbox_by_user_id
from om.server.features.build.db.sandbox import update_sandbox_heartbeat
from om.server.features.build.db.sandbox import update_sandbox_status__no_commit
from om.server.features.build.sandbox import get_sandbox_manager
from om.server.features.build.sandbox.kubernetes.internal.acp_exec_client import (
    SSEKeepalive,
)
from om.server.features.build.sandbox.models import LLMProviderConfig
from om.server.features.build.sandbox.tasks.tasks import (
    _get_disabled_user_library_paths,
)
from om.server.features.build.session.prompts import BUILD_NAMING_SYSTEM_PROMPT
from om.server.features.build.session.prompts import BUILD_NAMING_USER_PROMPT
from om.server.features.build.session.prompts import (
    FOLLOWUP_SUGGESTIONS_SYSTEM_PROMPT,
)
from om.server.features.build.session.prompts import FOLLOWUP_SUGGESTIONS_USER_PROMPT
...
class SessionManager:
    ...
    def create_session__no_commit(
        ...
        if MULTI_TENANT:
            from om.server.features.build.configs import (
    ...
    def _check_nextjs_ready(self, sandbox_id: UUID, port: int) -> bool:
        ...
        from om.server.features.build.sandbox.base import get_sandbox_manager
    ...
    def terminate_user_sandbox(self, user_id: UUID) -> bool:
        ...
        """
        from om.server.features.build.db.sandbox import (
            update_sandbox_status__no_commit,
        )
