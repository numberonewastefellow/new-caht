...
from om.db.document import get_accessible_documents_for_hierarchy_node_paginated
from om.db.engine.sql_engine import get_session
from om.db.hierarchy import get_accessible_hierarchy_nodes_for_source
from om.db.models import User
from om.server.features.hierarchy.constants import DOCUMENT_PAGE_SIZE
from om.server.features.hierarchy.constants import HIERARCHY_NODE_DOCUMENTS_PATH
from om.server.features.hierarchy.constants import HIERARCHY_NODES_LIST_PATH
from om.server.features.hierarchy.constants import HIERARCHY_NODES_PREFIX
from om.server.features.hierarchy.models import DocumentPageCursor
from om.server.features.hierarchy.models import DocumentSortDirection
from om.server.features.hierarchy.models import DocumentSortField
from om.server.features.hierarchy.models import DocumentSummary
from om.server.features.hierarchy.models import HierarchyNodeDocumentsRequest
from om.server.features.hierarchy.models import HierarchyNodeDocumentsResponse
from om.server.features.hierarchy.models import HierarchyNodesResponse
from om.server.features.hierarchy.models import HierarchyNodeSummary
...
def _require_opensearch(db_session: Session) -> None:  # noqa: ARG001
    if not ENABLE_OPENSEARCH_INDEXING_FOR_OM:
        raise HTTPException(
            status_code=403,
