...
from om.llm.utils import litellm_thinks_model_supports_image_input
from om.llm.utils import model_is_reasoning_model
from om.server.manage.llm.utils import DYNAMIC_LLM_PROVIDERS
from om.server.manage.llm.utils import extract_vendor_from_model_name
from om.server.manage.llm.utils import filter_model_configurations
from om.server.manage.llm.utils import is_reasoning_model
...
class ModelConfigurationView(BaseModel):
    ...
    def from_model(
        ...
        from om.llm.model_name_parser import parse_litellm_model_name
