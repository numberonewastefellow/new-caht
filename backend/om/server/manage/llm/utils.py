...
from om.llm.constants import BEDROCK_MODEL_NAME_MAPPINGS
from om.llm.constants import LlmProviderNames
from om.llm.constants import OLLAMA_MODEL_NAME_MAPPINGS
from om.llm.constants import OLLAMA_MODEL_TO_VENDOR
...
def filter_model_configurations(
    ...
    from om.llm.well_known_providers.llm_provider_options import is_obsolete_model
