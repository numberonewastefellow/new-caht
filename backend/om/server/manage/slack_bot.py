...
from om.db.slack_channel_config import remove_slack_channel_config
from om.db.slack_channel_config import update_slack_channel_config
from om.onyxbot.slack.config import validate_channel_name
from om.server.manage.models import SlackBot
from om.server.manage.models import SlackBotCreationRequest
from om.server.manage.models import SlackChannelConfig
from om.server.manage.models import SlackChannelConfigCreationRequest
from om.server.manage.validate_tokens import validate_app_token
from om.server.manage.validate_tokens import validate_bot_token
from om.server.manage.validate_tokens import validate_user_token
...
def _form_channel_config(
    ...
    if respond_tag_only and respond_member_group_list:
        raise ValueError(
            "Cannot set VertualAi Bot to only respond to tags only and "
    ...
    if (
        ...
        raise ValueError(
            "Cannot set VertualAi Bot to respond to users in a private (ephemeral) message "
