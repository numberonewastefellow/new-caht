...
from om.background.celery.tasks.pruning.tasks import (
    try_creating_prune_generator_task,
)
from om.background.celery.versioned_apps.client import app as client_app
from om.configs.app_configs import EMAIL_CONFIGURED
from om.configs.app_configs import ENABLED_CONNECTOR_TYPES
from om.configs.app_configs import MOCK_CONNECTOR_FILE_PATH
...
from om.connectors.google_utils.google_auth import (
    get_google_oauth_creds,
)
from om.connectors.google_utils.google_kv import (
...
from om.connectors.google_utils.google_kv import get_auth_url
from om.connectors.google_utils.google_kv import (
    get_google_app_cred,
)
from om.connectors.google_utils.google_kv import (
...
from om.connectors.google_utils.google_kv import verify_csrf
from om.connectors.google_utils.shared_constants import DB_CREDENTIALS_DICT_TOKEN_KEY
from om.connectors.google_utils.shared_constants import (
    GoogleOAuthAuthenticationMethod,
)
from om.db.connector import create_connector
from om.db.connector import delete_connector
from om.db.connector import fetch_connector_by_id
from om.db.connector import fetch_connectors
from om.db.connector import fetch_unique_document_sources
from om.db.connector import get_connector_credential_ids
from om.db.connector import mark_ccpair_with_indexing_trigger
from om.db.connector import update_connector
from om.db.connector_credential_pair import add_credential_to_connector
from om.db.connector_credential_pair import (
    fetch_connector_credential_pair_for_connector,
)
from om.db.connector_credential_pair import get_cc_pair_groups_for_ids
from om.db.connector_credential_pair import get_connector_credential_pair
from om.db.connector_credential_pair import get_connector_credential_pairs_for_user
from om.db.connector_credential_pair import (
    get_connector_credential_pairs_for_user_parallel,
)
from om.db.credentials import cleanup_gmail_credentials
from om.db.credentials import cleanup_google_drive_credentials
from om.db.credentials import create_credential
from om.db.credentials import delete_service_account_credentials
from om.db.credentials import fetch_credential_by_id_for_user
from om.db.deletion_attempt import check_deletion_attempt_is_allowed
from om.db.document import get_document_counts_for_all_cc_pairs
...
from om.db.enums import IndexingMode
from om.db.federated import fetch_all_federated_connectors_parallel
from om.db.index_attempt import get_index_attempts_for_cc_pair
from om.db.index_attempt import get_latest_index_attempts_by_status
from om.db.index_attempt import get_latest_index_attempts_parallel
...
from om.file_processing.file_types import PLAIN_TEXT_MIME_TYPE
from om.file_processing.file_types import WORD_PROCESSING_MIME_TYPE
from om.file_store.file_store import FileStore
...
from om.server.documents.models import AuthStatus
from om.server.documents.models import AuthUrl
...
from om.server.documents.models import ConnectorFileInfo
from om.server.documents.models import ConnectorFilesResponse
from om.server.documents.models import ConnectorIndexingStatusLite
from om.server.documents.models import ConnectorIndexingStatusLiteResponse
from om.server.documents.models import ConnectorRequestSubmission
from om.server.documents.models import ConnectorSnapshot
from om.server.documents.models import ConnectorStatus
from om.server.documents.models import ConnectorUpdateRequest
from om.server.documents.models import CredentialBase
from om.server.documents.models import CredentialSnapshot
from om.server.documents.models import DocsCountOperator
from om.server.documents.models import FailedConnectorIndexingStatus
from om.server.documents.models import FileUploadResponse
from om.server.documents.models import GDriveCallback
from om.server.documents.models import GmailCallback
from om.server.documents.models import GoogleAppCredentials
from om.server.documents.models import GoogleServiceAccountCredentialRequest
from om.server.documents.models import GoogleServiceAccountKey
from om.server.documents.models import IndexedSourcesResponse
from om.server.documents.models import IndexingStatusRequest
from om.server.documents.models import ObjectCreationIdResponse
from om.server.documents.models import RunConnectorRequest
from om.server.documents.models import SourceSummary
...
def submit_connector_request(
    ...
    if EMAIL_CONFIGURED:
        try:
            subject = "VertualAI Craft Connector Request"
