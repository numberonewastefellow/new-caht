"""Tenant-specific usage limit overrides from the control plane."""
...
def unlimited(tenant_id: str) -> TenantUsageLimitOverrides:
    # imported lazily: om.server.usage_limits imports this module at module
    # scope, so a top-level import here would be circular
    from om.server.usage_limits import NO_LIMIT
