...
from om.auth.email_utils import send_forgot_password_email
from om.auth.email_utils import send_user_verification_email
from om.auth.invited_users import get_invited_users
from om.auth.invited_users import remove_user_from_invited_users
from om.auth.jwt import verify_jwt_token
from om.auth.pat import get_hashed_pat_from_request
from om.auth.schemas import AuthBackend
from om.auth.schemas import UserCreate
from om.auth.schemas import UserRole
from om.auth.schemas import UserUpdateWithRole
from om.configs.app_configs import AUTH_BACKEND
from om.configs.app_configs import AUTH_COOKIE_EXPIRE_TIME_SECONDS
from om.configs.app_configs import AUTH_TYPE
from om.configs.app_configs import EMAIL_CONFIGURED
from om.configs.app_configs import JWT_PUBLIC_KEY_URL
from om.configs.app_configs import PASSWORD_MAX_LENGTH
from om.configs.app_configs import PASSWORD_MIN_LENGTH
from om.configs.app_configs import PASSWORD_REQUIRE_DIGIT
from om.configs.app_configs import PASSWORD_REQUIRE_LOWERCASE
from om.configs.app_configs import PASSWORD_REQUIRE_SPECIAL_CHAR
from om.configs.app_configs import PASSWORD_REQUIRE_UPPERCASE
...
from om.configs.constants import ANONYMOUS_USER_UUID
...
from om.db.auth import get_access_token_db
from om.db.auth import get_default_admin_user_emails
from om.db.auth import get_user_count
from om.db.auth import get_user_db
from om.db.auth import SQLAlchemyUserAdminDB
...
class FastAPIUserWithLogoutRouter(FastAPIUsers[models.UP, models.ID]):
    ...
    def get_refresh_router(
        ...
        from om.auth.oauth_refresher import check_and_refresh_oauth_tokens
