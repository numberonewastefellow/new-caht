...
from om.configs.app_configs import EMAIL_FROM
from om.configs.app_configs import SENDGRID_API_KEY
from om.configs.app_configs import SMTP_PASS
from om.configs.app_configs import SMTP_PORT
from om.configs.app_configs import SMTP_SERVER
...
def send_email_with_sendgrid(
    ...
    from_email = Email(mail_from) if mail_from else Email("noreply@vertualai.app")
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="vertualai.app")
