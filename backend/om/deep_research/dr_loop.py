...
from om.configs.chat_configs import SKIP_DEEP_RESEARCH_CLARIFICATION
from om.configs.constants import MessageType
from om.db.tools import get_tool_by_name
from om.deep_research.dr_mock_tools import get_clarification_tool_definitions
from om.deep_research.dr_mock_tools import get_orchestrator_tools
from om.deep_research.dr_mock_tools import RESEARCH_AGENT_TASK_KEY
from om.deep_research.dr_mock_tools import RESEARCH_AGENT_TOOL_NAME
...
from om.prompts.deep_research.orchestration_layer import CLARIFICATION_PROMPT
from om.prompts.deep_research.orchestration_layer import FINAL_REPORT_PROMPT
from om.prompts.deep_research.orchestration_layer import FIRST_CYCLE_REMINDER
from om.prompts.deep_research.orchestration_layer import FIRST_CYCLE_REMINDER_TOKENS
from om.prompts.deep_research.orchestration_layer import (
    INTERNAL_SEARCH_CLARIFICATION_GUIDANCE,
)
from om.prompts.deep_research.orchestration_layer import (
    INTERNAL_SEARCH_RESEARCH_TASK_GUIDANCE,
)
from om.prompts.deep_research.orchestration_layer import ORCHESTRATOR_PROMPT
from om.prompts.deep_research.orchestration_layer import ORCHESTRATOR_PROMPT_REASONING
from om.prompts.deep_research.orchestration_layer import RESEARCH_PLAN_PROMPT
from om.prompts.deep_research.orchestration_layer import RESEARCH_PLAN_REMINDER
from om.prompts.deep_research.orchestration_layer import USER_FINAL_REPORT_QUERY
...
from om.server.query_and_chat.streaming_models import DeepResearchPlanDelta
from om.server.query_and_chat.streaming_models import DeepResearchPlanStart
...
from om.tools.fake_tools.research_agent import run_research_agent_calls
...
from om.tracing.framework.create import trace
...
def run_deep_research_llm_loop(
    ...
    with trace(
        ...
        from om.llm.litellm_singleton.config import initialize_litellm
