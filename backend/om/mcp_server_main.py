...
from om.configs.app_configs import MCP_SERVER_ENABLED
from om.configs.app_configs import MCP_SERVER_HOST
from om.configs.app_configs import MCP_SERVER_PORT
...
def main() -> None:
    ...
    from om.mcp_server.api import mcp_app
