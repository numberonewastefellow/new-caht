...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="VertualAI checkpoint saving and loading.")
    parser.add_argument(
        "--save", action="store_true", help="Save VertualAI state to directory."
    )
    parser.add_argument(
        "--load", action="store_true", help="Load VertualAI state from save directory."
    )
    parser.add_argument(
