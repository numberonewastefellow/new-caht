...
from om.context.search.federated.slack_search import fetch_and_cache_channel_metadata
...
from om.onyxbot.slack.listener import process_message
from om.onyxbot.slack.models import ChannelType
from om.db.tools import get_builtin_tool
from om.tools.built_in_tools import SearchTool
...
class TestSlackBotFederatedSearch:
    ...
    def _setup_slack_mocks(self, channel_name: str) -> tuple[list, list]:
        ...
        patches = [
            ...
            patch("om.context.search.federated.slack_search.query_slack"),
            patch("om.onyxbot.slack.listener.get_channel_type_from_id"),
            patch("om.context.search.utils.get_query_embeddings"),
        ]
    ...
    def _setup_query_slack_mock(
        ...
        from om.context.search.federated.slack_search import SlackQueryResult
...
@patch("om.context.search.federated.slack_search.get_redis_client")
...
def test_slack_channel_config_eager_loads_agent(db_session: Session) -> None:
    ...
    """
    from om.db.slack_channel_config import (
