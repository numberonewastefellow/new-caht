...
# from om.chat.turn.models import ChatTurnContext
...
# from om.tools.tool_implementations_v2.code_interpreter_client import (
#     CodeInterpreterClient,
# )
# from om.tools.tool_implementations_v2.python import _python_execution_core
# from om.tools.tool_implementations_v2.python import python
# from om.tools.tool_implementations_v2.tool_result_models import (
...
#     with patch(
#         "om.tools.tool_implementations_v2.python.get_tool_by_name"
#     ) as mock_get_tool:
#         mock_tool = Mock()
#         mock_tool.id = 1
...
#         with patch(
#             "om.tools.tool_implementations_v2.python.CODE_INTERPRETER_DEFAULT_TIMEOUT_MS",
#             1000,
#         ):
#             # Execute code
...
#     with patch(
#         "om.tools.tool_implementations.python.python_tool.CODE_INTERPRETER_BASE_URL",
#         "http://localhost:8000",
#     ):
...
#     ) as mock_get_tool:
#         with patch(
#             "om.tools.tool_implementations_v2.python.CodeInterpreterClient"
...
#         with patch(
#             "om.tools.tool_implementations_v2.python.CODE_INTERPRETER_MAX_OUTPUT_LENGTH",
#             5000,
#         ):
#             mock_tool = Mock()
#             mock_tool.id = 1
...
def test_code_interpreter_receives_chat_files(
    ...
    with (
        ...
        patch(
            "om.tools.tool_implementations.python.code_interpreter_client.CODE_INTERPRETER_BASE_URL",
            mock_url,
        ),
    ):
