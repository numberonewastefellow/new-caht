...
from om.db.discord_bot import register_guild
...
class TestBotConfigIsolationCloudMode:
    ...
    def test_cannot_create_bot_config_in_cloud_mode(self) -> None:
        ...
        with patch("om.configs.app_configs.AUTH_TYPE", AuthType.CLOUD):
            from fastapi import HTTPException

            from om.server.manage.discord_bot.api import _check_bot_config_api_access
    ...
    def test_bot_token_from_env_only_in_cloud(self) -> None:
        ...
        with (
            patch("om.onyxbot.discord.utils.DISCORD_BOT_TOKEN", "env_token"),
            patch("om.onyxbot.discord.utils.AUTH_TYPE", AuthType.CLOUD),
        ):
