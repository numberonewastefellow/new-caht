...
from ee.om.utils.license import get_license_status
from ee.om.utils.license import is_license_valid
...
class TestVerifyLicenseSignature:
    ...
    def test_valid_signature(self) -> None:
        ...
        with patch("ee.om.utils.license._get_public_key", return_value=public_key):
    ...
    def test_invalid_signature(self) -> None:
        ...
        with patch(
            "ee.om.utils.license._get_public_key",
