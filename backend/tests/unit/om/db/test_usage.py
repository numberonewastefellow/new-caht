...
from om.db.usage import get_current_window_start
from om.db.usage import get_or_create_tenant_usage
from om.db.usage import get_tenant_usage_stats
from om.db.usage import increment_usage
from om.db.usage import TenantUsageStats
...
class TestGetCurrentWindowStart:
    ...
    def test_weekly_window_aligns_to_monday(self) -> None:
        ...
        with patch("om.db.usage.USAGE_LIMIT_WINDOW_SECONDS", 604800):  # 1 week
...
class TestIncrementUsage:
    ...
    def test_increments_llm_cost(self) -> None:
        ...
        with patch("om.db.usage.get_or_create_tenant_usage", return_value=mock_usage):
...
class TestCheckUsageLimit:
    ...
    def test_passes_when_under_limit(self) -> None:
        ...
        with patch("om.db.usage.get_tenant_usage_stats", return_value=mock_stats):
            # Should not raise
            check_usage_limit(
                mock_session,
                UsageType.LLM_COST,
...
class TestWindowRollover:
    ...
    def test_new_window_resets_usage(self) -> None:
        ...
        with patch(
            "om.db.usage.get_current_window_start",
