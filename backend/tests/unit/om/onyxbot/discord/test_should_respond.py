...
from om.onyxbot.discord.handle_message import check_implicit_invocation
from om.onyxbot.discord.handle_message import should_respond
...
class TestBasicShouldRespond:
    ...
    async def test_should_respond_guild_disabled(
        ...
        with patch(
            ...
            with patch(
                "om.onyxbot.discord.handle_message.get_guild_config_by_discord_id",
    ...
    async def test_should_respond_guild_enabled(
        ...
        with patch(
            ...
            with (
                ...
                patch(
                    "om.onyxbot.discord.handle_message.get_channel_config_by_discord_ids",
    ...
    async def test_should_respond_require_mention_true_no_mention(
        ...
        with patch(
            ...
            with (
                ...
                patch(
                    "om.onyxbot.discord.handle_message.check_implicit_invocation",
                    return_value=False,
                ),
            ):
                result = await should_respond(
