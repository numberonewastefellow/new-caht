...
from om.onyxbot.discord.utils import get_bot_token
...
from om.server.manage.discord_bot.utils import REGISTRATION_KEY_PREFIX
...
class TestGetBotToken:
    ...
    def test_get_token_from_env(self) -> None:
        ...
        with patch("om.onyxbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"):
    ...
    def test_get_token_from_db(self) -> None:
        ...
        with (
            patch("om.onyxbot.discord.utils.DISCORD_BOT_TOKEN", None),
            patch("om.onyxbot.discord.utils.AUTH_TYPE", "basic"),  # Not CLOUD
            patch("om.onyxbot.discord.utils.get_session_with_tenant") as mock_session,
            patch(
                "om.onyxbot.discord.utils.get_discord_bot_config",
    ...
    def test_get_token_env_priority(self) -> None:
        ...
        with (
            patch("om.onyxbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"),
            patch(
                "om.onyxbot.discord.utils.get_discord_bot_config",
                return_value=mock_config,
            ),
