...
from om.utils.url import _is_ip_private_or_reserved
from om.utils.url import _validate_and_resolve_url
...
class TestValidateAndResolveUrl:
    ...
    def test_valid_http_scheme(self) -> None:
        ...
        with patch("om.utils.url.socket.getaddrinfo") as mock_getaddrinfo:
...
class TestSsrfSafeGet:
    ...
    def test_makes_request_to_validated_ip_http(self) -> None:
        ...
        with patch("om.utils.url.socket.getaddrinfo") as mock_getaddrinfo:
            ...
            with patch("om.utils.url.requests.get") as mock_get:
