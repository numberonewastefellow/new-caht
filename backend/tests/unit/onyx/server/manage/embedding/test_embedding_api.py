...
from om.server.manage.embedding.api import list_embedding_models
from om.server.manage.embedding.api import list_embedding_providers
...
def test_list_embedding_models_masks_api_key() -> None:
    ...
    with patch(
        "om.server.manage.embedding.api.get_all_search_settings",
...
def test_list_embedding_providers_uses_sensitive_value_masking_once() -> None:
    ...
    with patch(
        "om.server.manage.embedding.api.fetch_existing_embedding_providers",
