...
from om.connectors.sharepoint.connector import _REST_CTX_MAX_AGE_S
...
@patch("om.connectors.sharepoint.connector.acquire_token_for_rest")
@patch("om.connectors.sharepoint.connector.ClientContext")
...
@patch("om.connectors.sharepoint.connector.time")
@patch("om.connectors.sharepoint.connector.acquire_token_for_rest")
@patch("om.connectors.sharepoint.connector.ClientContext")
