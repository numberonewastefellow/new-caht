...
from om.context.search.federated.slack_search import _fetch_thread_context
from om.context.search.federated.slack_search import (
    fetch_thread_contexts_with_rate_limit_handling,
)
from om.context.search.federated.slack_search import SlackRateLimitError
from om.context.search.federated.slack_search import ThreadContextResult
...
class TestFetchThreadContext:
    ...
    @patch("om.context.search.federated.slack_search.WebClient")
    ...
    @patch("om.context.search.federated.slack_search.batch_get_user_profiles")
    @patch("om.context.search.federated.slack_search.WebClient")
...
class TestFetchThreadContextsWithRateLimitHandling:
    ...
    @patch("om.context.search.federated.slack_search._fetch_thread_context")
    @patch(
        "om.context.search.federated.slack_search.run_functions_tuples_in_parallel"
    )
