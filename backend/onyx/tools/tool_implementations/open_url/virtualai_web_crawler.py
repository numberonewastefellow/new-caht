...
from onyx.connectors.web.connector import BOT_DETECTION_GRACE_PERIOD_MS
from onyx.connectors.web.connector import DEFAULT_HEADERS
from onyx.connectors.web.connector import DEFAULT_USER_AGENT
from onyx.file_processing.html_utils import parse_html_with_trafilatura
...
class VirtualAIWebCrawler(WebContentProvider):
    ...
    def _playwright_fetch_batch(self, urls: list[str]) -> list[WebContent]:
        ...
        try:
            from onyx.connectors.web.connector import start_playwright
