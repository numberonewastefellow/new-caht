...
```html
<!-- Load the widget -->
<script type="module" src="https://cdn.vertualai.app/widget/1.0/dist/vertualai-widget.js"></script>

<!-- Configure and display -->
<vertualai-chat-widget
  backend-url="https://cloud.vertualai.app/api"
...
| ------------- | ------ | -------------------------------------------------------------------- |
| `backend-url` | string | Your VertualAI backend API URL (or set `VITE_WIDGET_BACKEND_URL` in .env) |
...
| `logo`             | string | VertualAI logo     | URL to custom logo image                 |
...
```html
<vertualai-chat-widget backend-url="https://cloud.vertualai.app/api" api-key="on_abc123">
</vertualai-chat-widget>
```
...
```html
<vertualai-chat-widget mode="launcher"></vertualai-chat-widget>
```
...
<div class="chat-container">
  <vertualai-chat-widget mode="inline"></vertualai-chat-widget>
</div>
```
...
- Node.js 18+ and npm
- Access to VertualAI backend API
...
│   └── assets/
│       └── logo.ts              # Default VertualAI logo (base64)
├── dist/                        # Build output
├── index.html
├── package.json
├── vite.config.ts
...
The widget communicates with these VertualAI backend endpoints:
...
3. **Deploy `dist/vertualai-widget.js` to your server**

4. **Customer embed:**
   ```html
   <script type="module" src="https://your-cdn.com/vertualai-widget.js"></script>
   <vertualai-chat-widget
     agent-id="1"
     agent-name="Support"
