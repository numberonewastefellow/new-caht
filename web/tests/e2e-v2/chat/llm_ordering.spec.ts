...
import { verifyCurrentModel } from "@tests/e2e-v2/utils/chatActions";
import { ensureImageGenerationEnabled } from "@tests/e2e-v2/utils/assistantUtils";
...
test.describe("LLM Ordering", () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    const apiClient = new OmApiClient(page.request);
