...
import { THEMES, setThemeBeforeNavigation } from "@tests/e2e-v2/utils/theme";
import { expectScreenshot } from "@tests/e2e-v2/utils/visualRegression";
...
const ADMIN_PAGES: AdminPageSnapshot[] = [
  ...
  },
  {
    ...
    // NOTE: the intro paragraph copy drifted post-rename; title-only check for now.
  },
  {
  ...
  },
  {
    ...
    path: "documents/sets",
    // Renamed "Document Sets" -> "Collections" in the UI. Intro copy drifted;
    // title-only check for now.
  ...
  },
  {
    ...
    options: {
      paragraphText:
        "Setup Slack bots that connect to VertualAI. Once setup, you will be able to ask questions to VertualAI directly from Slack. Additionally, you can:",
    },
  },
  {
