...
import { loginAs, loginAsRandomUser, apiLogin } from "@tests/e2e-v2/utils/auth";
import { OmApiClient } from "@tests/e2e-v2/utils/omApiClient";
import { expectElementScreenshot } from "@tests/e2e-v2/utils/visualRegression";
...
async function deleteAllProviders(client: OmApiClient): Promise<void> {
...
async function createFreshAdmin(
  ...
  const adminClient = new OmApiClient(page.request);
