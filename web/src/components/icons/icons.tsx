...
export const OnyxLogoTypeIcon = ({
  ...
  // size here is the overall width hint; derive icon & font from it
  const iconSize = Math.min(size * 0.28, 28);
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          background: "linear-gradient(135deg, #E8449A 0%, #C026D3 35%, #7C3AED 65%, #4338CA 100%)",
