...
// Documentation URLs
export const DOCS_BASE_URL = "https://docs.vertualai.com";
...
export const SERVER_SIDE_ONLY__PAID_ENTERPRISE_FEATURES_ENABLED =
  (process.env.ENABLE_PAID_ENTERPRISE_EDITION_FEATURES?.toLowerCase() ?? "true") === "true";
...
export const EE_ENABLED =
  (process.env.NEXT_PUBLIC_ENABLE_PAID_EE_FEATURES?.toLowerCase() ?? "true") === "true";
