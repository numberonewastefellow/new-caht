<h2 align="center">
    <a href="https://www.vertualai.com/?utm_source=vertualai_repo&utm_medium=github&utm_campaign=readme"> <img width="50%" src="https://github.com/vertualai/vertualai/blob/logo/VertualAILogoCropped.jpg?raw=true" /></a>
</h2>

<h1 align="center">VertualAI Craft</h1>
...
<p align="center">
  ...
  <img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/vertualai/vertualai" />
</p>
...
VertualAI Craft is an AI coding agent that creates web applications, documents, presentations, and more using your company's indexed knowledge. Users describe what they want in natural language, and the agent builds artifacts in an isolated sandbox environment with access to documents from connected sources like Linear, Slack, Google Drive, Confluence, and more.

For detailed documentation, visit [our docs](https://docs.vertualai.com/overview/core_features/craft).
...
- VertualAI deployment with an LLM provider configured (Anthropic, OpenAI, etc.)

### New Installations

You can install VertualAI Craft using our [quickstart script](https://docs.vertualai.com/deployment/getting_started/quickstart):

```bash
curl -fsSL https://raw.githubusercontent.com/vertualai/vertualai/main/deployment/docker_compose/install.sh > install.sh \
  && chmod +x install.sh \
...
- Filesystem-based sandboxes under `SANDBOX_BASE_PATH` (default: `/tmp/vertualai-sandboxes`)
...
3. For local development, sandboxes are created under `/tmp/vertualai-sandboxes`
